...
public class BottomNavigationBar extends FrameLayout {
    ...
    private int mFirstActiveColor = -1;
    private boolean mActiveTextIsBold = false;
...
//    }
     ...
     * @return this, to allow builder pattern
     */
    public BottomNavigationBar setFirstActiveColor(@ColorRes int activeColor) {
        this.mFirstActiveColor = ContextCompat.getColor(getContext(), activeColor);
        return this;
    }
...
//                && oldPosition != -1) {
    ...
    public boolean ismActiveTextIsBold() {
        return mActiveTextIsBold;
    }

    public BottomNavigationBar setmActiveTextIsBold(boolean mActiveTextIsBold) {
        this.mActiveTextIsBold = mActiveTextIsBold;
        return this;
    }
