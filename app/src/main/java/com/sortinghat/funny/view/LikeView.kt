...
//                addLikeView(e)
            ...
            override fun onSingleTapConfirmed(e: MotionEvent): Boolean {
                if (onPlayPauseListener != null) {
                    onPlayPauseListener!!.onPlayOrPause(isShow)
                }
                return true
            }
            ...
            override fun onLongPress(e: MotionEvent) {
                super.onLongPress(e)
                if (onLikeListener != null) {
                    onLikeListener!!.onDisLikeListener()
                }
            }
        })
    ...
    private fun addLikeView(e: MotionEvent) {
        ...
        imageView.setImageResource(R.mipmap.home_like)
        addView(imageView)
    ...
    interface OnPlayPauseListener {
        fun onPlayOrPause(boolean: Boolean)
    }
    ...
    fun setShow(boolean: Boolean) {
        this.isShow = boolean;
    }

    interface OnLikeListener {
        fun onLikeListener()
        fun onDisLikeListener()
    }
