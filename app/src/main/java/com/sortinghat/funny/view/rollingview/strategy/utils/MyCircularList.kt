package com.sortinghat.funny.view.rollingview.strategy.utils
 ...
 */
class MyCircularList<T> @JvmOverloads constructor(
    ...
    override fun subList(fromIndex: Int, toIndex: Int): List<T> =
            MyCircularList(list, toIndex - fromIndex, size + fromIndex)
