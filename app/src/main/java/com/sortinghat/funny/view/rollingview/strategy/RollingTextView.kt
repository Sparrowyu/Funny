...
class RollingTextView : View {
    ...
    private val textManager = MyTextManager(textPaint, charOrderManager)
    ...
    fun setText(text: CharSequence, animate: Boolean) {
        ...
        if (animate) {
            ...
            charStrategy = MyStrategy.NoAnimation()
            textManager.setText(text)
     ...
     *
     * 直接更替字符串
     * [MyStrategy.NoAnimation]
     *
     * 普通滚动
     * [MyStrategy.NormalAnimation]
     *
     * 指定方向滚动
     * [MyStrategy.SameDirectionAnimation]
     *
     * 进位滚动
     * [MyStrategy.NonZeroFirstCarryBitAnimation]
     */
    var charStrategy: MyCharOrderStrategy
        set(value) {
