...
import com.sortinghat.funny.view.rollingview.strategy.MyTextManager.Companion.EMPTY

@Suppress("MemberVisibilityCanBePrivate")
internal class TextColumn(
        private val manager: MyTextManager,
    ...
    fun setChangeCharList(charList: List<Char>, dir: MyDirection) {
    ...
    fun onAnimationUpdate(
            ...
            progress: Double): MyPreviousProgress {
        ...
        return MyPreviousProgress(index, offsetPercentage, progress, currentChar, currentWidth)
    }
