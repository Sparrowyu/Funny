...
public class CustomSwitchButton extends View {
    ...
    /** 开启颜色*/
    private int onColor = Color.parseColor("#00dc9a");
    /** 关闭颜色*/
    private int offBorderColor = Color.parseColor("#999999");
    /** 灰色带颜色*/
    private int offColor = Color.parseColor("#999999");
    /** 手柄颜色*/
    ...
    private CustomSwitchButton(Context context) {
        super(context);
    }
