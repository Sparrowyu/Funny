 ...
 */
public class ImageFragment extends BaseFragment<HomeViewModel, FragmentVideoOrImageBinding> implements MediaReadTask.Callback {
    ...
    private void scanMediaData() {
        MediaReader mediaReader = new MediaReader(activity, null, null, null, true);
        mMediaReadTask = new MediaReadTask(Album.FUNCTION_CHOICE_IMAGE, null, mediaReader, this);
