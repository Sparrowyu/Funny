...
public interface ICacheManager {
     ...
     */
    void doCacheLogic(Context context, LocalProxyVideoControl mLocalProxyVideoControl, IMediaPlayer mediaPlayer, String url, Map<String, String> header, File cachePath);
