...
public class GSYVideoOptionBuilder {
     ...
     * 代理缓存回调
     */
    public GSYVideoOptionBuilder setOnProxyCacheInfoListener(IPlayerManager.OnProxyCacheInfoListener onProxyCacheInfoListener) {
    ...
    public void build(GSYBaseVideoPlayer gsyVideoPlayer) {
        ...
        if (mOnProxyCacheInfoListener != null) {
            ((GSYVideoManager) gsyVideoPlayer.getGSYVideoManager()).setOnProxyCacheInfoListener(mOnProxyCacheInfoListener);
        }
