...
public abstract class GSYVideoBaseManager implements IMediaPlayer.OnPreparedListener, IMediaPlayer.OnCompletionListener,
    ...
    protected IPlayerManager.OnProxyCacheInfoListener mOnProxyCacheInfoListener;
     ...
     * 本地代理服务
     */
    protected LocalProxyVideoServer localProxyVideoServer;
    ...
    private void initVideo(Message msg) {
        try {
            ...
            if (localProxyVideoServer != null) {
                localProxyVideoServer.shutdown();
                localProxyVideoServer = null;
            }
            if (playerManager != null) {
                playerManager.release();
            }
            localProxyVideoServer = new LocalProxyVideoServer();
            localProxyVideoServer.setLocalProxyListener(e -> {
                onInfo(null, MediaPlayer.MEDIA_ERROR_IO, 0);
            });
            ...
            if (playerManager instanceof BasePlayerManager) {
                ...
                ((BasePlayerManager) playerManager).setOnProxyCacheInfoListener(mOnProxyCacheInfoListener);
            }
